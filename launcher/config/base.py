...
BACKEND_VERSION_PATH = PROJECT_ROOT_PATH / "backend" / "VERSION"

SECRETS_PATH = PROJECT_ROOT_PATH / "secrets"
ENV_PROD_GPG_PATH = SECRETS_PATH / ".env.prod.gpg"
INIT_DATABASE_SQL_PATH = SECRETS_PATH / "init_database.sql"

SCRIPTS_POSTGRESQL_PATH = PROJECT_ROOT_PATH / "scripts" / "postgresql"
INIT_DATABASE_SQL_TEMPLATE_PATH = SCRIPTS_POSTGRESQL_PATH / "init_database.sql.j2"

# 通用配置
POD_NERWORK_NAME = "twila_network"
POD_NETWORK_ARG = f"--network {POD_NERWORK_NAME}"

COMMAND_REQUIRED_DEV = {"podman": "--version"}
COMMAND_REQUIRED_PROD = {"podman": "--version", "gpg": "--list-keys"}
